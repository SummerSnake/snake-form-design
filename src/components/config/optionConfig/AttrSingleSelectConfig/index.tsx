...
interface AttrSingleSelectProps {
  activeIndex: number;
}

const AttrSingleSelect: FC<AttrSingleSelectProps> = (props) => {
    ...
    <>
      ...
      >
        <div className="configTitleWrap">
          <p className="configTitle">属性选择(单选)</p>
        </div>
...
export default React.memo(AttrSingleSelect);
