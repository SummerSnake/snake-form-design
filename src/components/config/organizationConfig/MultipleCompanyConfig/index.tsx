...
interface MultipleCompanyConfigProps {
  activeIndex: number;
}

const MultipleCompanyConfig: FC<MultipleCompanyConfigProps> = (props) => {
...
export default React.memo(MultipleCompanyConfig);
